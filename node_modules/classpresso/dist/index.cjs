...
__export(files_exports, {
  DEFAULT_PATTERNS: () => exports.DEFAULT_PATTERNS,
...
async function scanBuildOutput(config) {
  ...
  const fileStats = [];
  const errors = [];
  const patterns = config.include.length > 0 ? config.include : exports.DEFAULT_PATTERNS;
...
function generateHashName(normalizedClassString, prefix = "cp-", length = 5) {
  const hash = crypto__default.default.createHash("md5").update(normalizedClassString).digest("hex").substring(0, length);
  return `${prefix}${hash}`;
}
...
async function loadConfig(buildDir) {
  ...
  for (const configPath of configPaths) {
    try {
      const fullPath = path2__default.default.resolve(process.cwd(), configPath);
...
exports.ALL_CLASS_PATTERNS = ALL_CLASS_PATTERNS;
exports.CLASS_PATTERNS = CLASS_PATTERNS;
exports.DEFAULT_CONFIG = DEFAULT_CONFIG;
exports.DEFAULT_DYNAMIC_PREFIXES = DEFAULT_DYNAMIC_PREFIXES;
exports.DYNAMIC_BASE_PATTERNS = DYNAMIC_BASE_PATTERNS;
exports.backupFile = backupFile;
exports.buildReplacementMap = buildReplacementMap;
exports.calculateMetrics = calculateMetrics;
exports.containsDynamicPrefix = containsDynamicPrefix;
exports.createClassMappings = createClassMappings;
exports.detectConsolidatablePatterns = detectConsolidatablePatterns;
exports.detectMergeablePatterns = detectMergeablePatterns;
exports.escapeRegex = escapeRegex;
exports.estimateCSSOverhead = estimateCSSOverhead;
exports.extractDynamicBaseStrings = extractDynamicBaseStrings;
exports.findFiles = findFiles;
exports.formatBytes = formatBytes;
exports.formatPercentage = formatPercentage;
exports.formatTime = formatTime;
exports.generateConsolidatedCSS = generateConsolidatedCSS;
exports.generateHashName = generateHashName;
exports.getFileSize = getFileSize;
exports.getPatternSummary = getPatternSummary;
exports.injectConsolidatedCSS = injectConsolidatedCSS;
exports.isDynamicClassString = isDynamicClassString;
exports.isProperSubset = isProperSubset;
exports.loadConfig = loadConfig;
exports.loadMappingManifest = loadMappingManifest;
exports.normalizeClassString = normalizeClassString;
exports.parseUtilityClass = parseUtilityClass;
exports.readFileContent = readFileContent;
exports.resolveCollisions = resolveCollisions;
exports.saveMappingManifest = saveMappingManifest;
exports.scanBuildOutput = scanBuildOutput;
exports.shouldExcludeClass = shouldExcludeClass;
exports.transformBuildOutput = transformBuildOutput;
